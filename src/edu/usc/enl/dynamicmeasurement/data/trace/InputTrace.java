...
public class InputTrace {
    ...
    public TaskTraceReader getTaskTraceReader(Task2 task, int taskStart, boolean cache) throws IOException {
        return new TaskTraceReader(task, taskStart, task.getFilter(), packetsFile, this.wildcardPattern, cache);
    }
}
